...
import img2 from "../assets/images/girl1.png";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {categories.map((category, idx) => (
            <div
              ...
              className="cursor-pointer bg-white border border-[#BFEFFF] rounded-3xl shadow-md transition hover:shadow-xl group overflow-hidden"
            >
              <div className="p-4">
                <img
                  src={category.image}
